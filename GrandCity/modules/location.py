...
def gen_plr(client, server):
    ...
    plr["ci"] = {"exp": user_data["exp"], "crt": user_data["crt"],
                 ...
                 "strfrd": 0, "rtrtm": 0, "kyktid": None,
                 "actrt": user_data["act"], "compid": 0, "actrp": 0,
                 "actrd": 0, "shousd": False, "rpt": user_data["rpt"], "as": None,
                 "lvt": user_data["lvt"], "lrnt": 0, "lwts": 0, "skid": None,
                 "skrt": 0, "bcld": 0, "trid": user_data["trid"], "trcd": 0,
                 "sbid": None, "sbrt": 0, "plcmt": {}, "pamns": {"amn": []},
                 "crst": 0}
